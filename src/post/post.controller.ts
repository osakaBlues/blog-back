import { Controller, Delete, Get, HttpStatus, Logger, Param, Post, Put, Query, Res } from "@nestjs/common";
...
export class PostController {
  ...
  @ApiResponse({ status: 200, description: '해당 id의 포스트를 요청합니다.', type: String })
  ...
  getPostWithId(@Param('id') id: number, @Res() res: Response) {
    ...
    res.status(HttpStatus.OK).json(new PostDto({
      author: "test",
      title: "test",
      content: "test",
      date: new Date(),
